...
# /*FALL 2, ORANGE TEAM 6: UCM FOR FINAL PROJECT  */
#   
#   *Create library;
...
# test <- data.table::fread('~/MSA 21/AA 502/Time Series/Final/all_test_data.csv')
# valid <- data.table::fread('~/MSA 21/AA 502/Time Series/Final/all_validation_data.csv')
